...
public class RespuestaService {
    ...
    @Autowired
    private List<ValidarRespuesta> validarRespuesta;
    ...
    public EstadoRespuestaDTO marcarDesmarcarComoSolucion(Long id) {
        idValido(id);
        ...
        var resultado = new EstadoRespuestaDTO(new TopicoDTO(topico), new RespuestaDTO(respuesta));
        return resultado;
    }
